    ...
    <section class="about-us">
        <div class="container">
            <div class="row">
                ...
                <!-- <div class="col-md-6">
                    <img src="<?php echo e(asset('images/about-us.jpg')); ?>" alt="О нас" class="img-fluid">
                </div> -->
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\профиль+роли\Ковалев степан меропритие начало\end (2)\end\resources\views/about.blade.php ENDPATH**/ ?>