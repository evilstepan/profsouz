...
<head>
    ...
    <script src="<?php echo e(asset('js/lich.js')); ?>" defer></script>
</head>
<body>
    <div class="dashboard">
        <aside class="sidebar">
            <div class="profile-card">
                <?php if(Auth::check()): ?>
                    <a class="profile-link" href="<?php echo e(route('index7')); ?>">
                        <div class="profile-image">
                            <img src="<?php echo e(asset('img/free-icon-boy-4537069.png')); ?>" alt="Фото профиля" id="profile-pic">
                        </div>
                    </a>
                    <div class="profile-info">
                        <h2 id="user-name"><?php echo e(Auth::user()->full_name); ?></h2>
                        <p id="user-email"><?php echo e(Auth::user()->email); ?></p>
                        <p id="user-phone"><?php echo e(Auth::user()->phone); ?></p>
                    </div>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="profile-link">
                        <div class="profile-image">
                            <img src="<?php echo e(asset('img/free-icon-boy-4537069.png')); ?>" alt="Фото профиля" id="profile-pic">
                        </div>
                    </a>
            ...
            <nav class="main-nav">
                <?php if(request()->routeIs('lich')): ?>
                    <?php if(Auth::user()->role === 'organize'): ?>
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=orders'">
                            <i class="fas fa-clipboard-list"></i>
                            Заявки
                        </button>
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=events'">
                            <i class="fas fa-calendar-alt"></i>
                            Мероприятия
                        </button>
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=create'">
                            <i class="fas fa-calendar-plus"></i>
                            Заказать мероприятие
                        </button>
                        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="nav-item">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=edit'">
                            <i class="fas fa-user-edit"></i>
                            Редактировать профиль
                        </button>
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=history'">
                        ...
                        <button class="nav-item" onclick="window.location.href='<?php echo e(route('lich')); ?>?tab=accepted'">
        ...
        <main class="main-content">
            ...
            <div class="content-body">
                <?php if(Auth::user()->role === 'organize'): ?>
                    <?php if(request()->get('tab') === 'orders'): ?>
                        <div class="card orders-list">
                            ...
                            <div class="events-grid">
                                <?php $__empty_1 = true; $__currentLoopData = $orderedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="event-card" data-name="<?php echo e(strtolower($event->name)); ?>">
                                        <div class="event-image">
                                            <?php if($event->image_path): ?>
                                                <img src="<?php echo e(asset('storage/'.$event->image_path)); ?>" alt="Изображение">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('img/mer.WEBP')); ?>" alt="Изображение по умолчанию">
                                            <?php endif; ?>
                                        </div>
                                        <div class="event-content">
                                            <h4><?php echo e($event->name); ?></h4>
                                            <div class="event-details">
                                                <p><i class="fas fa-calendar"></i> <?php echo e($event->date_time ? $event->date_time->format('Y-m-d H:i') : 'Дата не указана'); ?></p>
                                                <p><i class="fas fa-map-marker-alt"></i> <?php echo e($event->location); ?></p>
                                                <p><i class="fas fa-user"></i> <?php echo e($event->responsible_person); ?></p>
                                                <p><i class="fas fa-users"></i> <?php echo e($event->getCurrentParticipantsCount()); ?>/<?php echo e($event->max_participants ?? '∞'); ?></p>
                                                <?php if($event->description): ?>
                                                    <p><i class="fas fa-info-circle"></i> <?php echo e(strip_tags($event->description)); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="event-actions">
                                                <form action="<?php echo e(route('event.status.update', $event->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <div class="status-controls">
                                                        <select name="status" class="status-select">
                                                            <option value="pending" <?php echo e($event->status === 'pending' ? 'selected' : ''); ?>>Ожидает</option>
                                                            <option value="accepted" <?php echo e($event->status === 'accepted' ? 'selected' : ''); ?>>Принято</option>
                                                            <option value="rejected" <?php echo e($event->status === 'rejected' ? 'selected' : ''); ?>>Отклонено</option>
                                                        </select>
                    ...
                    <?php elseif(request()->get('tab') === 'events'): ?>
                            ...
                            <div class="events-grid">
                                <?php $__empty_1 = true; $__currentLoopData = $myEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="event-card" data-name="<?php echo e(strtolower($event->name)); ?>">
                                        <div class="event-image">
                                            <?php if($event->image_path): ?>
                                                <img src="<?php echo e(Storage::url($event->image_path)); ?>" alt="<?php echo e($event->name); ?>">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('img/mer.WEBP')); ?>" alt="Default event image">
                                            <?php endif; ?>
                                        </div>
                                        <div class="event-content">
                                            <h4><?php echo e($event->name); ?></h4>
                                            <div class="event-details">
                                                <p><i class="fas fa-calendar"></i> <?php echo e($event->date_time); ?></p>
                                                <p><i class="fas fa-map-marker-alt"></i> <?php echo e($event->location); ?></p>
                                                <p><i class="fas fa-user"></i> <?php echo e($event->responsible_person); ?></p>
                                                <?php if($event->description): ?>
                                                    <p><i class="fas fa-info-circle"></i> <?php echo e($event->description); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="event-actions">
                    ...
                    <?php elseif(request()->get('tab') === 'create'): ?>
                            ...
                            <form action="<?php echo e(route('events.store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" id="event-date-time" name="event-date-time" 
                                           ...
                                           max="<?php echo e(now()->addYears(10)->format('Y-m-d\TH:i')); ?>" 
                                           required>
                                </div>
                                <div class="form-group">
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php if(request()->get('tab') === 'edit'): ?>
                        <div class="card edit-form">
                            <h3>Редактировать профиль</h3>
                            <form id="edit-profile-form" action="<?php echo e(route('profile.update')); ?>" method="POST" onsubmit="event.preventDefault(); saveProfile();">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <div class="form-group">
                                    <label for="edit-full-name">ФИО</label>
                                    <input type="text" name="full_name" id="edit-full-name" value="<?php echo e(Auth::user()->full_name); ?>" required />
                                </div>
                                <div class="form-group">
                                    <label for="edit-email">Email</label>
                                    <input type="email" name="email" id="edit-email" value="<?php echo e(Auth::user()->email); ?>" required />
                                </div>
                                <div class="form-group">
                                    <label for="edit-phone">Телефон</label>
                                    <input type="tel" name="phone" id="edit-phone" value="<?php echo e(Auth::user()->phone); ?>" required />
                                </div>
                                <button type="submit" class="btn-primary">Сохранить изменения</button>
                            </form>
                            <div class="password-change-link">
                                <a href="<?php echo e(route('password.change')); ?>" class="btn-secondary">
                                    <i class="fas fa-key"></i> Изменить пароль
                                </a>
                            </div>
                        </div>
                    <?php elseif(request()->get('tab') === 'history'): ?>
                        <div class="card orders-list">
                            <h3>Мои мероприятия</h3>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $orderedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="event-card">
                                        ...
                                        <div class="event-content">
                                            ...
                                            <div class="event-actions">
                                                <span class="status-badge <?php echo e(strtolower($event->status ?? 'pending')); ?>">
                                                    <?php echo e($event->status ?? 'N/A'); ?>
                    ...
                    <?php elseif(request()->get('tab') === 'accepted'): ?>
                        <div class="card accepted-events-list">
                            <h3>Принятые мероприятия</h3>
                            <div class="events-grid">
                                <?php if($acceptedEvents->count() > 0): ?>
                                    <?php $__currentLoopData = $acceptedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acceptedEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="event-card">
                                            <div class="event-image">
                                                <?php if($acceptedEvent->event->image_path): ?>
                                                    <img src="<?php echo e(Storage::url($acceptedEvent->event->image_path)); ?>" 
                                                        alt="<?php echo e($acceptedEvent->event->name); ?>">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('img/mer.WEBP')); ?>" alt="Default event image">
                                                <?php endif; ?>
                                            </div>
                                            <div class="event-content">
                                                <h4><?php echo e($acceptedEvent->event->name); ?></h4>
                                                <div class="event-details">
                                                    <p><i class="fas fa-calendar"></i> <?php echo e($acceptedEvent->event->date_time); ?></p>
                                                    <p><i class="fas fa-map-marker-alt"></i> <?php echo e($acceptedEvent->event->location); ?></p>
                                                    <p><i class="fas fa-user"></i> <?php echo e($acceptedEvent->event->responsible_person); ?></p>
                                                    <?php if($acceptedEvent->event->description): ?>
                                                        <p><i class="fas fa-info-circle"></i> <?php echo e($acceptedEvent->event->description); ?></p>
                                                    <?php endif; ?>
                                                </div>
                                                <form action="<?php echo e(route('accepted-events.destroy', $acceptedEvent->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
...
<?php /**PATH D:\xamp\профиль+роли\Ковалев степан меропритие начало\end (2)\end\resources\views/lich.blade.php ENDPATH**/ ?>